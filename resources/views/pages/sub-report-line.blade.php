                                ...
                                <div class="row">
                                    ...
                                    ['id' => 'budget_by_months', 'icon' => 'fa-line-chart', 'title' => "Budget in ", 'dropdown' => 'false'])
                                        <!-- widget content -->
                                            <div class="widget-body no-padding">
                                                <div class="widget-body-toolbar bg-color-white smart-form">
                                                    <p class="text-danger text-right"><strong>ME / RE: </strong><span id="me_re_by_months">{{ $budget["me_re"]  or '0'}}</span>%</p>
                                                    <div class="row" id="budget_by_months_chk">
                                                        <div class="col col-sm">
                                                            <div class="form-check">
                                                                <label class="form-check-label">
                                                                    <input type="checkbox" class="form-check-input" value="L1" checked>
                                                ...
                                                <div id="budget_by_months_chart" class="chart has-legend"></div>
                                            </div>
                                        @endcomponent
                                    </article>
                                    ...
                                    ['id' => 'quantity_by_months', 'icon' => 'fa-line-chart', 'title' => "Quantity in ", 'dropdown' => 'false'])
                                        <!-- widget content -->
                                            <div class="widget-body no-padding">
                                                <div class="widget-body-toolbar bg-color-white smart-form">
                                                    <div class="row" id="quantity_by_months_chk">
                                                        <div class="col col-sm">
                                                            <div class="form-check">
                                                                <label class="form-check-label">
                                                                    <input type="checkbox" class="form-check-input" value="L1" checked>
                                                ...
                                                <div id="quantity_by_months_chart" class="chart has-legend"></div>
                                            </div>
                                        @endcomponent
                                    </article>
                                    ...
                                    ['id' => 'quality_by_months', 'icon' => 'fa-line-chart', 'title' => "Quality in ", 'dropdown' => 'false'])
                                        <!-- widget content -->
                                            <div class="widget-body no-padding">
                                            {{--@component('components.budget_chart', ['id' => 'quality_by_months_chart', 'chk' => 'quality_by_months_chk'])--}}
